...
protected:
  Eigen::VectorXd pose_to_vectorXd(const Pose& pose);
   ...
   * points Format: timetamp(s) tx ty tz qx qy qz qw)
   */
  void feed_trajectory(const std::vector<Eigen::VectorXd>& traj_points);
