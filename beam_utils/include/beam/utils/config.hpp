 ...
 * ```
 *
 * Conversions for the following types are included in of beam_utils:
 * - Eigen::Matrix2d
 * - Eigen::Matrix3d
 * - Eigen::Matrix4d
 * - Eigen::MatrixXd
 ...
 * ```
 *
 * Conversions for the following types are compiled as part of beam_utils:
 * - Eigen::Vector2d
 * - Eigen::Vector3d
 * - Eigen::Vector4d
 * - Eigen::VectorXd
...
template struct convert<beam::Mat2>;
template struct convert<beam::Mat3>;
template struct convert<beam::Mat4>;
template struct convert<beam::MatX>;
template struct convert<beam::Vec2>;
template struct convert<beam::Vec3>;
