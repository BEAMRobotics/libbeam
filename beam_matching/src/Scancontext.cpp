...
std::pair<int, float> SCManager::detectLoopClosureID ( void )
{
    ...
    beam::nanoflann::KNNResultSet<float> knnsearch_result( NUM_CANDIDATES_FROM_TREE );
    knnsearch_result.init( &candidate_indexes[0], &out_dists_sqr[0] );
    polarcontext_tree_->index->findNeighbors( knnsearch_result, &curr_key[0] /* query */, beam::nanoflann::SearchParams(10) ); 
