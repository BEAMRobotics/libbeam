#ifndef BEAM_GROUNDSEGMENTATION_IMPL_HPP
#define BEAM_GROUNDSEGMENTATION_IMPL_HPP
...
#define PCL_INSTANTIATE_GroundSegmentation(T) \
    template class PCL_EXPORTS beam::GroundSegmentation<T>;
#endif  // PCL_NO_PRECOMPILE

#endif  // BEAM_GROUNDSEGMENTATION_IMPL_HPP
