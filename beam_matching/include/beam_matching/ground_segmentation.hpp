...
#ifndef BEAM_GROUNDSEGMENTATION_HPP
#define BEAM_GROUNDSEGMENTATION_HPP
 ...
 *  libbeam_matching for PCL's standard 3D point types (see
 *  PCL_XYZ_POINT_TYPES).
 *  To use it with a custom point type, add the following to your source file:
 *  ```
 *  #include <beam_matching/impl/ground_segmentation.hpp>
 *  ```
 */
...
#endif  // BEAM_GROUNDSEGMENTATION_HPP
